// Adopted from https://github.com/privacy-scaling-explorations/zkevm-circuits/blob/2783eba338274a52036bf3db7fbc29575e24aa9f/gadgets/src/less_than.rs
...
use crate::util::{bool_check, expr_from_bytes, pow_of_two};
    ...
    fn row_diff_is_lt() {
        ...
        impl<F: FieldExt> Circuit<F> for TestCircuit<F> {
            ...
            fn configure(meta: &mut ConstraintSystem<F>) -> Self::Config {
                ...
                let lt = meta.advice_column();
                let diff = [(); 8].map(|_| meta.advice_column());
